...
namespace ProductService.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
     ...
     //   private readonly IHttpClientFactory _httpClientFactory;
        ...
        public ProductController(IProductServices productServices )//,IHttpClientFactory httpClientFactory)
        {
        ...
        public int? IsProductExistsInventory([FromQuery]Guid id,[FromQuery] Guid categoryId )
        {
